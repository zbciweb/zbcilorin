...
import Gallery1 from '../../src/assets/images/gallery-1@1.5x.jpg'
import Gallery2 from '../../src/assets/images/gallery-2@1.5x.jpg'
import Gallery3 from '../../src/assets/images/gallery-3@2x.jpg'
import Gallery4 from '../../src/assets/images/gallery-4@2x.jpg'
import Gallery5 from '../../src/assets/images/gallery-4@1.5x.jpg'
import Gallery6 from '../../src/assets/images/gallery-5@2x.jpg'
import Gallery7 from '../../src/assets/images/gallery-5@1.5x.jpg'
import Gallery8 from '../../src/assets/images/gallery-6@2x.jpg'
import Gallery9 from '../../src/assets/images/gallery-7@1.5x.jpg'
import Gallery10 from '../../src/assets/images/gallery-8@1.5x.jpg'
    ...
    <div className="row align-items-center">
      ...
      <div className="flex-md-9">
        ...
        <div className="event">
          <div className="event__metas horizontal">
            ...
            <div className="event__meta--location meta"><i className="ri-map-pin-line"></i> <span>123 Jay St, Albany, NY
                12203</span></div>
          </div>
      ...
      <div className="flex-md-3">
        <div className="next-event__cta">
          <Link href="events-single.html" className="button button-block-sm">Learn more</Link>
        </div>
      </div>
  ...
  <div className="container">
    ...
    <div className="row align-items-center">
      ...
      <div className="flex-md-6 flex-lg-5">
        <div className="card sermon" data-aos="fade-up" data-aos-offset="400">
          
          <div className="card__header">
            <img src={Sermon} alt="A man reading the Holy Bible"
      ...
      <div className="flex-md-6 flex-lg-7">
        <div className="last-sermon__content" data-aos="fade-up" data-aos-offset="300" data-aos-delay="300">
          ...
          <div className="sermon__metas">
            <div className="sermon__meta--date meta"><i className="ri-calendar-event-line"></i> <span>02/28/2020</span>
            </div>
        ...
        <div className="row">
          ...
          <div className="flex-lg-12">
            ...
            <div className="card ministry custom-height">
              ...
              <div className="card__header">
                <img src={Ministry2} alt="Young women praying"
                  className="card__image ministry__image"/>
              </div>
...
<section className="our-gallery gallery gallery--equal-grid default-section-spacing text-center">
  ...
  <div className="row">
    ...
    <div className="flex-md-6 flex-lg-3 no-padding no-margin">
      ...
      <a href="images/gallery-1@2x.jpg" className="gallery-link" data-lightbox="church-picture"
        ...
        <div className="card gallery__card">
          ...
          <div className="card__header">
            <img src={Gallery1} alt="The Holy Bible" 
    ...
    <div className="flex-md-6 flex-lg-3 no-padding no-margin">
      ...
      <a href={Gallery3} className="gallery-link" data-lightbox="church-picture"
    ...
    <div className="flex-md-6 flex-lg-3 no-padding no-margin">
      ...
      <a href={Gallery4} className="gallery-link" data-lightbox="church-picture"
        data-title="Inside of a church">

        <div className="card gallery__card">

          <div className="card__header">
            <img src={Gallery5} alt="Inside of a church" className="card__image"/>
          </div>
    ...
    <div className="flex-md-6 flex-lg-3 no-padding no-margin">
      ...
      <a href={Gallery6} className="gallery-link" data-lightbox="church-picture"
        data-title="Picture of people worshiping in church">

        <div className="card gallery__card">

          <div className="card__header">
            <img src={Gallery7} alt="People worshiping in church" className="card__image"/>
          </div>
    ...
    <div className="flex-md-6 flex-lg-3 no-padding no-margin">
      ...
      <a href={Gallery8} className="gallery-link" data-lightbox="church-picture"
        data-title="Picture of women laughing">

        <div className="card gallery__card">

          <div className="card__header">
            <img src={Gallery8} alt="Women laughing" className="card__image"/>
          </div>
    ...
    <div className="flex-md-6 flex-lg-3 no-padding no-margin">
      ...
      <a href="images/gallery-7@2x.jpg" className="gallery-link" data-lightbox="church-picture"
        ...
        <div className="card gallery__card">
          ...
          <div className="card__header">
            <img src={Gallery9} alt="Worship leader singing" className="card__image"/>
          </div>
    ...
    <div className="flex-md-6 flex-lg-3 no-padding no-margin">
      ...
      <a href={Gallery10} className="gallery-link" data-lightbox="church-picture"
        data-title="Picture of a smart kid at school">

        <div className="card gallery__card">

          <div className="card__header">
            <img src={Gallery10} alt="Smart kid at school" className="card__image"/>
          </div>
              ...
              <div className="testimonial">
                ...
                <div className="testimonial__avatar">
                  <div className="card card--picture card--square testimonial__user">
                    ...
                    <div className="card__header">
                      <img src={User1} alt="A man" className="card__image"/>
                    </div>

                    <div className="card__footer">
                      <div className="testimonial__author">George E. Pugh</div>
                    </div>
              ...
              <div className="testimonial">
                ...
                <div className="testimonial__avatar">
                  <div className="card card--picture card--square testimonial__user">
                    ...
                    <div className="card__header">
                      <img src={User2} alt="A woman" className="card__image"/>
                    </div>

                    <div className="card__footer">
                      <div className="testimonial__author">Nancy A. Austin</div>
                    </div>
              ...
              <div className="testimonial">
                ...
                <div className="testimonial__avatar">
                  <div className="card card--picture card--square testimonial__user">
                    ...
                    <div className="card__header">
                      <img src={User3} alt="A man" className="card__image"/>
                    </div>

                    <div className="card__footer">
                      <div className="testimonial__author">Joe K. Liley</div>
                    </div>
        ...
        <div className="card blog">
          ...
          <div className="card__footer">
            ...
            <div className="blog__content">
              ...
              <div className="blog__link"><Link href="blog-single.html" className="button">Read more</Link></div>
            </div>
      ...
      <div className="row">
        ...
        <div className="flex-md-9">
          <div className="form__group">
            <input type="email" className="form__input" placeholder="Enter your valid email address" />
          </div>
        </div>

        <div className="flex-md-3">
          <button type="submit" className="button button-block-sm form__submit">Subscribe today</button>
        </div>
